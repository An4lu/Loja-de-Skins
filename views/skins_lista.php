...
<body style="background: url('../public/img/backloll.jpg')">
    <header id="header">
        ...
        <nav id="nav">
            ...
            <ul id="menu">
                <li><a href="../views/adm_menu.php"><img src="../public/img/usu.png"></a></li>
                ...
                <section class="cards">
                    <div class="card">
                        ...
                        <div class="contentBx">
                            ...
                            <a href="../views/skins_exclui.php?id=<?= $skin['id_skin'] ?>" class="buy">Excluir </a>
                            <a href="../views/skins_altera.php?id=<?= $skin['id_skin'] ?>" class="buy">Alterar</a>
                        </div>
                    </div>
                </section>
            <?php endforeach; ?>
